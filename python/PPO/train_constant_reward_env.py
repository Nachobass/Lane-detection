...
def parse_args():
    ...
    p.add_argument("--logdir", default="runs/constant_reward_ppo_clip")
    p.add_argument("--save_path", default="runs/constant_reward_ppo_clip/final.pt")
...
def main():
    ...
    # Configure PPO for ConstantRewardEnv (simple environment, smaller network is fine)
    cfg = PPOConfig(
        gamma=0.99,
        gae_lambda=0.95,
        clip_range=0.2,
    ...
    print("  - ConstantRewardEnv: Always gives reward=1 and terminates immediately")
    print("-" * 50)
